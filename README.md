...
仓库内已包含原生微信小程序适配版，目录为 [`miniprogram/`](miniprogram/)；它不是网页 WebView，也不需要 ChatGPT 登录。当前小程序版本为 `0.1.2-mp`，具备进店、预算、选票、整本、逐步刮膜、柜台验奖和奖金换票的完整闭环。
...
`0.1.2` 已于 2026-08-08 上传为微信公众平台开发版本。后续版本可通过仓库内的官方上传工具发布，具体命令和密钥安全要求见迁移文档。
