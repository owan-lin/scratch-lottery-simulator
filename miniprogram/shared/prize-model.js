 ...
 */
function makeBookPrizePool(type, random = Math.random) {
...
const BOOK_PROFILES = ORDINARY_BOOK_PROFILES;
const PRIZE_MODEL_INTERNALS = { makeOfficialGroupBook };

module.exports = { makeBookPrizePool, makeSeededRandom, BOOK_PROFILES, PRIZE_MODEL_INTERNALS };
